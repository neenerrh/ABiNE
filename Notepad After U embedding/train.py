...
def train_by_sampling(args):
    model_path = os.path.join('C:/Users/Administrator/Desktop/New_folder/experiment/Bine', args.model_name)
    ...
    datafile= os.path.join(model_path,"rating.dat")
    ...
    model_path1 = os.path.join('C:/Users/Administrator/Desktop/New_folder/experiment/Bine', 'model')    
    one=OneMode(model_path1)
    #graph_file= os.path.join(model_path,'cora_adjlist')
...
def main():
    ...
    parser.add_argument('--train-data', default=r'data/mvl/ratings_test.dat',
                        help='Input graph file.')

    parser.add_argument('--test-data', default=r'data/mvl/ratings_test.dat')

    parser.add_argument('--model-name', default='data/mvl',
                        help='name of model.')

    parser.add_argument('--vectors-u', default=r'data/mvl/vectors_u.dat',
                        help="file of embedding vectors of U")

    parser.add_argument('--vectors-v', default=r'data/mvl/vectors_v.dat',
    ...
    parser.add_argument('--u_graph_file', default= r'data/mvl/homogeneous_u.dat',
                        help='graph/network file')
    parser.add_argument('--v_graph_file', default= r'data/mvl/homogeneous_v.dat',
                        help='graph/network file')
    parser.add_argument('--u_attribute_file', default=r'data/mvl/u_attr.txt',
                        help='node attribute/feature file')
    parser.add_argument('--v_attribute_file', default=r'data/mvl/v_attr.txt',
                        help='node attribute/feature file')
